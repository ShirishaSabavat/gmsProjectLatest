...
const Listitemgarage = ({
  ...
  <div className="box-border mt-px">
    <div className="flex flex-row flex-nowrap mx-5">
      <h1 className="text-base font-quicksand-semi-bold font-medium basis-1/3 bg-white h-16 p-4 mr-1">{garage_name.length > 15 ? garage_name.substring(0, 15) : garage_name}{garage_name.length > 15 ? "..." : ""}</h1>
      <h1 className="text-base font-quicksand-semi-bold font-medium basis-1/3 bg-white h-16 p-4 mr-1">{garage_manager}</h1>
      <h1 className="text-base font-quicksand-semi-bold font-medium basis-1/3 bg-white h-16 p-4 mr-1">{garage_members.length > 15 ? garage_members.substring(0, 13) : garage_members}{garage_members.length > 13 ? "..." : ""}</h1>
