...
const Listitemteamgarage = ({
  team_id, garage_name, garage_id, status, locationId
}) => (
  <div className="box-border mx-5">
    <div className="flex flex-row flex-nowrap">
      ...
      <Link to={{ pathname: 'addteam', state: { teamId: team_id, garageId: garage_id, locationId: locationId } }} className="basis-1/6 bg-white p-4 mr-1 pt-4 h-16">
