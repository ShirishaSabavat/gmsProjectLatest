...
const Listitemlocation = ({
  locationId, garage_id, locationName, createdOn, status,
}) => (
  <div className="box-border mt-px">
    <div className="flex flex-row flex-nowrap mx-5">
      <h1 className="text-base font-quicksand-semi-bold font-medium basis-1/2 bg-white h-16 p-4 mr-1">{locationName}</h1>
      <h1 className="text-base font-quicksand-semi-bold font-medium basis-1/2 bg-white h-16 p-4 mr-1">{createdOn}</h1>
      ...
      <Link to={{ pathname: 'addPickupLocation', state: { locationId, garage_id } }} className="basis-1/5 bg-white p-4 mr-1 pt-4 h-16">
