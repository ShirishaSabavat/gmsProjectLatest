    ...
    <div>
      ...
      <div className="box-border h-100">
        <div className="flex flex-row flex-nowrap">
          <h1 className="text-base font-quicksand-medium font-medium basis-1/5 bg-white p-4 mr-0.5">Role Title</h1>
          <h1 className="text-base font-quicksand-medium font-medium basis-1/5 bg-white p-4 mr-0.5">Assigned To</h1>
          <h1 className="text-base font-quicksand-medium font-medium basis-1/5 bg-white p-4 mr-0.5">Total Modules</h1>
          <h1 className="text-base font-quicksand-medium font-medium basis-1/5 bg-white p-4 mr-0.5">Created On</h1>
          <h1 className="text-base font-quicksand-medium font-medium basis-1/7 bg-white p-4 mr-0.5">Status</h1>
          <h1 className="text-base font-quicksand-medium font-medium basis-1/7 bg-white p-4 mr-0.5">Action</h1>
        </div>
