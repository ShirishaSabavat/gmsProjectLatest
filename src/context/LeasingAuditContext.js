...
const LeasingAuditContext = createContext(
  {
...
const LeasingProvider = ({ children }) => {
  ...
  return (
    <LeasingAuditContext.Provider value={{
      selectedCarID,
      setselectedCarID,
      carReturnReason,
      setCarReturnReason,
    ...
    >
      {children}
    </LeasingAuditContext.Provider>
  );
};

export const useLeasingContext = () => useContext(LeasingAuditContext);
export default LeasingProvider;
