...
const ServiceAuditContext = createContext(
  {
...
const ServiceProvider = ({ children }) => {
  ...
  return (
    <ServiceAuditContext.Provider value={{
      selectedCarID,
      setselectedCarID,
      carReturnReason,
      setCarReturnReason,
    ...
    >
      {children}
    </ServiceAuditContext.Provider>
  );
};

export const useServiceContext = () => useContext(ServiceAuditContext);
