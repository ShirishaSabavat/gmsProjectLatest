...
const RepairAuditContext = createContext(
  {
...
const RepairProvider = ({ children }) => {
  ...
  return (
    <RepairAuditContext.Provider value={{
      selectedCarID,
      setselectedCarID,
      carReturnReason,
      setCarReturnReason,
    ...
    >
      {children}
    </RepairAuditContext.Provider>
  );
};

export const useRepairContext = () => useContext(RepairAuditContext);
